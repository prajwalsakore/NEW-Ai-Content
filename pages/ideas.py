...
st.markdown("Here are some content ideas:")
st.write("- How to build a personal brand using AI")
st.write("- 10 blog post ideas for digital marketers")
st.write("- Tips for writing high-converting emails")
